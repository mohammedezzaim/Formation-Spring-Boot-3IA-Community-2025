package tia.community.annotation_transactional;
...
public class AnnotationTransactionalApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		ioc_container = SpringApplication.run(AnnotationTransactionalApplication.class, args);
	}
